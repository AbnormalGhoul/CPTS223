...
int main() {
    ...
    // Logs the parameters
    logFile << "VectorMyJosephus Simulation: N = " << N << ", M = " << M << std::endl;

    // Initializes the game
    VectorMyJosephus game(M, N, cityNames);
    ...
    game.printAllDestinations(logFile); // Pass logFile to printAllDestinations
