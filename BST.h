 ...
 // Initializes the static class variable for counting nodes to zero
 template <typename T>
 ...
 protected:
     ...
     /* Clones a passed in tree, returns pointer to new tree */
     ...
     /* Prints tree out in inorder (A + B) */
     ...
     /* Prints tree out in post order (A B +) */
     ...
     /* Prints tree out in pre order (+ A B) */
     ...
     /* Prints tree out in level order */
     ...
     /* Returns height of tree (root == nullptr -> 0) */
